...
height = 2
velocity = np.reshape(velocity, (1000, 6))
angle = np.reshape(angle, (1000, 6))
...
max_throw_distance = np.amax(throw_distance, axis=1)
print(
f'''
Throw distance [R]: {max_throw_distance}
'''
)

#
values = max_throw_distance
alpha = 0.05
values.sort()
